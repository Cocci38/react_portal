    ...
    return (
        <>
            ...
            <div
                ...
                className=""
            ></div>
            <div className={!showModalBis ? "modal" : "modal opacity"}>
                <div className="modal-content"><button className={!showModalBis ? "buttonModal" : "buttonHide"} onClick={() => setShowModalBis(true)}>Mini</button>
                    ...
                    <button className={!showModalBis ? "buttonModal" : "buttonHide"} onClick={() => setShowModalBis(true)}>Couleurs</button>
                    {showModalBis && createPortal(
                        <ModalColor closeModalBis={() => setShowModalBis(false)} />,
                        document.body
                    )}</div>
                <button
